...
euler_2.step(0.1)
assert (round(euler_2.point[0],5), [round(euler_2.point[1][i],5) for i in range(len(euler_2.point[1]))]) == (0.1, (0.1, 0, 0)), "EulerEstimator 2's step_forward() was not right, it should be (0.1, (0.1, 0, 0)), but was {}".format(tuple(euler_2.point))
...
print("    Testing EulerEstimator 2's step_forward()")
euler_2.step(-0.5)
assert (round(euler_2.point[0],5), [round(euler_2.point[1][i],5) for i in range(len(euler_2.point[1]))]) == (-0.4, (-0.45, 0.05, 0)), "EulerEstimator 2's step_forward() was not right, it should be (-0.4, (-0.45, 0.05, 0)), but was {}".format(tuple(euler_2.point))
print("    EulerEstimator 2's step_forward() Passed!!!\n")

print("    Testing EulerEstimator 2's go_to_input()")
euler_2.go_to_input(3, 0.5)
assert (round(euler_2.point[0],5), [round(euler_2.point[1][i],5) for i in range(len(euler_2.point[1]))]) == (3, (13.75, 2.35, -3.4)), "EulerEstimator's go_to_input() was not right, it should be (3, (13.75, 2.35, -3.4)), but was {}".format(tuple(euler_2.point))
print("    EulerEstimator 2's go_to_input() Passed!!!\n")
euler_2.go_to_input(5, step_size = 2)
