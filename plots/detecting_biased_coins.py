...
plt.plot([i for i in range(0, 4)], [probability(i, 3)
                                    for i in range(0, 4)], linewidth=2.5)
plt.plot([i for i in range(0, 4)],
         make_graph_for_biased_coins(coin_1), linewidth=1)
plt.plot([i for i in range(0, 4)],
         make_graph_for_biased_coins(coin_2), linewidth=1)
plt.plot([i for i in range(0, 4)],
         make_graph_for_biased_coins(coin_3), linewidth=1)
