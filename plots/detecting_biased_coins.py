...
plt.plot([i for i in range(0, 26)], [coin_1[i].count('H') for i in range(0, 26)], linewidth=1)
plt.plot([i for i in range(0, 26)], [coin_2[i].count('H') for i in range(0, 26)], linewidth=1)
plt.plot([i for i in range(0, 26)], [coin_3[i].count('H') for i in range(0, 26)], linewidth=1)
