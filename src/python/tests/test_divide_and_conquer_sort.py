...
assert result == [1, 2, 3, 4, 5, 6,
                  7], 'List #1 was wrong and was {}'.format(result)
print('List #1 Passed!')
...
assert result == [1, 2, 3, 4, 5, 6, 7, 8,
                  9], 'List #2 was wrong and was {}'.format(result)
print('List #2 Passed!')
...
assert result == [1, 2, 3, 4, 5, 6,
                  7], 'List #3 was wrong and was {}'.format(result)
print('List #3 Passed!')
...
assert result == [1, 2, 3, 4, 5, 6, 7, 8,
                  9], 'List #4 was wrong and was {}'.format(result)
print('List #4 Passed!')
