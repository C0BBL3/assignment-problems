...
print(sum([random_draw([0.5, 0.5]) for i in range(0,1001)])/1000)
print(sum([random_draw([0.25, 0.25, 0.5]) for i in range(0,1001)])/1000)
print(sum([random_draw([0.05, 0.2, 0.15, 0.3, 0.1, 0.2]) for i in range(0,1001)])/1000)